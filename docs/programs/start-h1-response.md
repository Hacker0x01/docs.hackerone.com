...
3. *(Optional)* Click the **[Human Augmented Signal](https://hacker0x01.github.io/docs.hackerone.com/programs/human-augmented-signal.html)** toggle to be either on or off. 
