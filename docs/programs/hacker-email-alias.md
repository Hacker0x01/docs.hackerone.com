...
How can I send credentionals to all hackers in my program? | Go to your Invitation settings (Settings -> Program -> Invitations) to see the list of hackers in your program; you can email username@wearehackerone.com for each hacker to provide credentials.
