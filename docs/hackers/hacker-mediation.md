...
>Note: HackerOne does not accept Mediation Requests for Disclosure Assistance reports submitted through the [Disclosure Assistance HackerOne-managed program](https://hackerone.com/disclosure-assistance?type=team). HackerOne also does not accept Hacker Mediation Requests for reports submitted to Basic programs not managed by HackerOne. 
