...
Minimum Bounty | The minimum bounty that will be given for a valid vulnerability. If the field is marekd with a `-` this means that there is no minimum bounty.
